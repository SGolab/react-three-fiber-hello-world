...
# Getting Started with Create React Scene

This project was bootstrapped with [Create React Scene](https://github.com/facebook/create-react-app).
...
You can learn more in the [Create React Scene documentation](https://facebook.github.io/create-react-app/docs/getting-started).
